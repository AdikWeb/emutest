    ...
    return (
        function (Module) {
            ...
            var _wasm_input_update = Module["_wasm_input_update"] = function () {
                return (_wasm_input_update = Module["_wasm_input_update"] = Module["asm"]["p"]).apply(null, arguments)
            };
            var _init = Module["_init"] = function () {
                return (_init = Module["_init"] = Module["asm"]["q"]).apply(null, arguments)
            };
            var _start = Module["_start"] = function () {
                return (_start = Module["_start"] = Module["asm"]["r"]).apply(null, arguments)
            };
            var _tick = Module["_tick"] = function () {
                return (_tick = Module["_tick"] = Module["asm"]["s"]).apply(null, arguments)
            };
            var _sound = Module["_sound"] = function () {
                return (_sound = Module["_sound"] = Module["asm"]["t"]).apply(null, arguments)
            };
            var _get_rom_buffer_ref = Module["_get_rom_buffer_ref"] = function () {
                return (_get_rom_buffer_ref = Module["_get_rom_buffer_ref"] = Module["asm"]["u"]).apply(null, arguments)
            };
            var _get_frame_buffer_ref = Module["_get_frame_buffer_ref"] = function () {
                return (_get_frame_buffer_ref = Module["_get_frame_buffer_ref"] = Module["asm"]["v"]).apply(null, arguments)
            };
            var _get_web_audio_l_ref = Module["_get_web_audio_l_ref"] = function () {
                return (_get_web_audio_l_ref = Module["_get_web_audio_l_ref"] = Module["asm"]["w"]).apply(null, arguments)
            };
            var _get_web_audio_r_ref = Module["_get_web_audio_r_ref"] = function () {
                return (_get_web_audio_r_ref = Module["_get_web_audio_r_ref"] = Module["asm"]["x"]).apply(null, arguments)
            };
            var _get_input_buffer_ref = Module["_get_input_buffer_ref"] = function () {
                return (_get_input_buffer_ref = Module["_get_input_buffer_ref"] = Module["asm"]["y"]).apply(null, arguments)
            };
